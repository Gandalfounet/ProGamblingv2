...
function Trade(params) {
    ...
    //Roulette variables
    this.id_roulette = 0
    this.intervalRoulette = false
    this.preparingRoulette = time_prepare_roulette
    this.currentRouletteBet = []
    this.currentRouletteBet[0] = []
    this.currentRouletteBet[1] = []
    this.currentRouletteBet[2] = []
    this.historyRoulette = []
    this.hashRoulette = ""


    //Deposit variables
    this.intervalDeposit = []
